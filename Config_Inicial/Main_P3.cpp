...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::translate(view, glm::vec3(0.0f,4.5f,-12.0f));
		model = glm::rotate( model, 0.6f, glm::vec3( 1.0f, 0.0f, 0.0f ) ); // use to compare orthographic and perspective projection
		...
		model = glm::mat4(1);											//Cubo enmedio izquierda
		model = glm::translate(model, glm::vec3(-2.6f, -4.0f, 0.0f));
		model = glm::rotate(model, 3.5f, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);


		model = glm::mat4(1);											//Cubo enmedio derecha
		model = glm::translate(model, glm::vec3(2.6f, -4.0f, 0.0f));
		model = glm::rotate(model, 1.9f, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, 1.74533f, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);


		model = glm::mat4(1);											//Cubo inferior centro
		model = glm::translate(model, glm::vec3(0.0f, -8.5f, 0.0f));
		model = glm::rotate(model, 4.8f, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);


		model = glm::mat4(1);											//Cubo inferior izquierda
		model = glm::translate(model, glm::vec3(-5.1f, -8.5f, 0.0f));
		...
		model = glm::mat4(1);											//Cubo inferior derecha
		model = glm::translate(model, glm::vec3(5.1f, -8.5f, 0.0f));
		model = glm::rotate(model, 0.4f, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, -1.74533f, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
